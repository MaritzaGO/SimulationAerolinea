...
class AirplanesControllerTest < ActionController::TestCase
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post :create, airplane: { count_passengers: @airplane.count_passengers, reference: @airplane.reference, state_airplane: @airplane.state_airplane }
    end
  ...
  test "should update airplane" do
    patch :update, id: @airplane, airplane: { count_passengers: @airplane.count_passengers, reference: @airplane.reference, state_airplane: @airplane.state_airplane }
    assert_redirected_to airplane_path(assigns(:airplane))
  end
